...
class TencentcosStorage extends Storage
{
    ...
    {
        $this->region = getSetting("tx_region") ?: 'bj';
        $this->accessKey = getSetting("tx_accesskey");
        $this->secretKey = getSetting("tx_secretkey");
        $this->bucket = getSetting("tx_space");
        $this->domain = getSetting("tx_domain");
    ...
    public function upload(string $uploadPath, File $file): array
    {
        ...
        $name = $uploadPath . "/" . $this->getNewKey() . "." . $fileInfo['orgin'];
