...
class QiniuStorage extends Storage
{
    ...
    {
        $this->bucket = getSetting('space');
        $this->accessKey = getSetting('access_key');
        $this->secretKey = getSetting('secret_key');
        $this->domain = getSetting('domain');
