...
class AliossStorage extends Storage
{
    ...
    {
        $this->point = getSetting('al_region');
        $this->bucket = getSetting('al_space');
        $this->accessKey = getSetting('al_accesskey');
        $this->secretKey = getSetting('al_secretkey');
        $this->domain = getSetting('al_domain');
